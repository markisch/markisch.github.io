...
* `quadrants`: quadrant block characters which yield double resolution in both directions. They are available since [Unicode 3.2](https://www.unicode.org/charts/PDF/Unicode-3.2/U32-2580.pdf) and with most fonts. This the default.
